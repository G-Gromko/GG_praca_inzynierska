...
Trenowanie odbywało się na platformie Google Colab, na instancji wyposażonej w układ GPU NVidia Tesla T4 oraz 51 GB pamięci operacyjnej, przez \textbf{DO-UZUPEŁNIENIA-JAK-SIĘ-MODEL-NAUCZY} epok, w ciągu \textbf{DO-UZUPEŁNIENIA-JAK-SIĘ-MODEL-NAUCZY} sesji środowiska Google Colab, na przestrzeni \textbf{DO-UZUPEŁNIENIA-JAK-SIĘ-MODEL-NAUCZY} dni. Łączny czas uczenia modelu wyniósł około \textbf{DO-UZUPEŁNIENIA-JAK-SIĘ-MODEL-NAUCZY} godzin.

Otrzymany model posiada 20,8 miliona parametrów.

\begin{lstlisting}[caption={Główna funkcja uczenia modelu}, label={model-main}]
